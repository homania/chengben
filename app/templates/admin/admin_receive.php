                ...
                <div class="profile-body">
                    ...
                    <div class="row margin-bottom-10">
                        <div class="col-sm-6 sm-margin-bottom-20">
                            <div class="service-block-v3 servive-block-u">
                                ...
                                <span class="service-heading">Clicks This Month</span>
                                ...
                                <div class="row margin-bottom-20">
                                    <div class="col-xs-6 service-in">
                                        <small>Revenue Due</small>
                                        <h4 class="counter">14,385</h4>
                                    </div>
                                    <div class="col-xs-6 text-right service-in">
                                        <small>Last Month</small>
                                        <h4 class="counter">56,048</h4>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="service-block-v3 servive-block-blue">
                                ...
                                <span class="service-heading">TOTAL UNCOLLECTED</span>
                                <span class="counter">34,670</span>
                                ...
                                <div class="row margin-bottom-20">
                                    <div class="col-xs-6 service-in">
                                        ...
                                        <h4 class="counter">12,904</h4>
                                    </div>
                                    <div class="col-xs-6 text-right service-in">
                                        <small>Pending CASH/ DD</small>
                                        <h4 class="counter">21,766</h4>
                                    </div>
                                </div>
                                <div class="statistics">
                    ...
                    <hr>
                        <div class="panel-heading overflow-h">
                            <h2 class="panel-title heading-sm pull-left"><i class="fa fa-tasks"></i>Receivables Calendar </h2>
                        ...
                        <div class="table-responsive">
                         <div class="tab-v1">
                            <ul class="nav nav-justified nav-tabs">
                                <li><a data-toggle="tab" href="#profile">Receivables Calendar</a></li>
                                <li class="active"><a data-toggle="tab" href="#passwordTab">Add/ Edit Receivable</a></li>
                            </ul>
                   		</div>
 <form action="../test/php/formmail.php" method="post" name="OrderForm" id="sky-form" class="sky-form">
                        ...
                        <div class="row">
                            <section class="col col-6">
                                <label class="input">
                                    <i class="icon-append fa fa-envelope"></i>
                                    <input type="email" name="EmailAddr" placeholder="Description i.e. Monthly Fee">
                                </label>   
                            </section>
                            <section class="col col-6">
                                <label class="input">
                                    <i class="icon-append fa fa-envelope"></i>
                                    <input type="email" name="EmailAddr" placeholder="Date">
                                </label>   
                            </section>
                         </div>
						<div class="row">
                            <section class="col col-6">
                                <label class="select">
                                    <select name="L1Cate">
                                        <option value="none" selected disabled style="display:none">Receivable Type</option>
                         ...
                         <div class="row">
                            <section class="col col-6">
                                <label class="input">
                                    <i class="icon-append fa fa-envelope"></i>
                                    <input type="text" name="Price" placeholder="Receive Date">
                                </label>
                            </section>
                            <section class="col col-6">
                                <label class="select">
                    ...
                    <div class="table-search-v1 margin-bottom-20">
                        ...
                        <div class="table-responsive">
                         <div class="tab-v1">
                            <ul class="nav nav-justified nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#profile">Vendors Outstanding</a></li>
                    ...
                    <div class="table-search-v2 margin-bottom-20">
                       <div class="panel-heading overflow-h">
                            <h2 class="panel-title heading-sm pull-left"><i class="fa fa-tasks"></i>Outstanding Vendor</h2>
                            <a href="#" class="btn-u btn-brd btn-brd-hover btn-u-dark btn-u-xs pull-right" style="margin-left:20px;">View All</a>
