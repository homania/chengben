...
try:
    ENGINE = create_engine('mysql+mysqldb://root:sh030780@localhost/chengben?charset=utf8', echo=True)
except ImportError:
    ENGINE = create_engine('mysql+pymysql://root:sh030780@localhost/chengben?charset=utf8', echo=True)
